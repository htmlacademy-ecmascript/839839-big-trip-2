...
/* harmony import */ var _mock_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mock/description */ "./src/mock/description.js");


class DestinationModel extends _framework_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #destinationsModel = _mock_description__WEBPACK_IMPORTED_MODULE_1__.mockDestinations;
  get destinations() {
...
class OfferModel extends _framework_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #offersModel = _mock_offers__WEBPACK_IMPORTED_MODULE_1__.mockOffers;
  get offers() {
...
/* harmony import */ var _mock_description_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/description.js */ "./src/mock/description.js");
/* harmony import */ var _mock_offers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mock/offers.js */ "./src/mock/offers.js");
...
class PointModel extends _framework_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #points = Array.from({
    length: POINT_COUNT
  }, _mock_data_js__WEBPACK_IMPORTED_MODULE_1__.getRandomPoint);
  #allDestinations = _mock_description_js__WEBPACK_IMPORTED_MODULE_2__.mockDestinations;
  #allOffers = _mock_offers_js__WEBPACK_IMPORTED_MODULE_3__.mockOffers;
  get points() {
    return this.#points;
  }
...
/* harmony import */ var _view_filters_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/filters-view.js */ "./src/view/filters-view.js");
...
class FilterPresenter {
  ...
  get filters() {
    ...
    return Object.values(_const__WEBPACK_IMPORTED_MODULE_0__.FilterType).map(type => ({
      type,
      count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__.filter[type](points).length
    }));
  }
  init() {
    const filters = this.filters;
    const prevFilterComponent = this.#filterComponent;
    this.#filterComponent = new _view_filters_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
      filters,
      currentFilterType: this.#filterModel.filter,
      onFilterTypeChange: this.#handleFilterTypeChange
    });
    if (prevFilterComponent === null) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_1__.render)(this.#filterComponent, this.#filterContainer);
      return;
    }
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_1__.replace)(this.#filterComponent, prevFilterComponent);
  ...
  #handleFilterTypeChange = filterType => {
    ...
    this.#filterModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_0__.UpdateType.MAJOR, filterType);
  };
}
...
/* harmony import */ var _view_message_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/message-view.js */ "./src/view/message-view.js");
...
/* harmony import */ var _new_event_presenter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./new-event-presenter.js */ "./src/presenter/new-event-presenter.js");
/* harmony import */ var _utils_sort_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/sort.js */ "./src/utils/sort.js");
...
class TripPresenter {
  ...
  #sortContainer = null;
  #filterModel = null;
  #listPointsComponent = new _view_list_points_view_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  #routeComponent = new _view_route_view_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  #sortComponent = null;
  #messageComponent = null;
  #pointPresenters = new Map();
  #newEventPresenter = null;
  #currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_5__.SortType.DAY;
  ...
  constructor({
    ...
    this.#filterModel = filterModel;
    this.#newEventPresenter = new _new_event_presenter_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
  ...
  get points() {
    ...
    const points = this.#pointModel.points;
    const filteredPoint = _utils_filter_js__WEBPACK_IMPORTED_MODULE_9__.filter[this.#filterType](points);
    switch (this.#currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_5__.SortType.DAY:
        return filteredPoint.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortPointByDay);
      case _const_js__WEBPACK_IMPORTED_MODULE_5__.SortType.TIME:
        return filteredPoint.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortPointByDuration);
      case _const_js__WEBPACK_IMPORTED_MODULE_5__.SortType.PRICE:
        return filteredPoint.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortPointByPrice);
    }
    return filteredPoint.sort(_utils_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortPointByDay);
  }
  init() {
  ...
  createPoint() {
    this.#filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_5__.UpdateType.MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_5__.FilterType.EVERYTHING);
   ...
   */
  #renderRoute = () => {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this.#routeComponent, this.#routeContainer, _framework_render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.AFTERBEGIN);
  };
  ...
  #renderSort = () => {
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this.#sortComponent, this.#sortContainer, _framework_render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.AFTERBEGIN);
  };
  #handleViewAction = (actionType, updateType, update) => {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_5__.UserAction.UPDATE_POIN:
  ...
  #clearTrip = ({
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.#sortComponent);
    if (this.#messageComponent) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.#messageComponent);
    }
    if (resetSortType) {
      this.#currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_5__.SortType.DAY;
    }
  };
   ...
   */
  #renderPoint = point => {
    const pointPresenter = new _point_presenter_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
  ...
  #renderMessage() {
    this.#messageComponent = new _view_message_view_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      filterType: this.#filterType
    });
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this.#messageComponent, this.#tripContainer);
  }
   ...
   */
  #renderTrip = () => {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this.#listPointsComponent, this.#tripContainer);
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-${point.id}" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(isCheckDescription(pointDestination))}" list="destination-list-${point.id}" required>
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-${point.id}" type="text" name="event-start-time" value="${(0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_1__.formatDate)(isDateFrom, _const_js__WEBPACK_IMPORTED_MODULE_2__.DateFormat.SHORT_DATE_TIME)}" required>
            &mdash;
            <label class="visually-hidden" for="event-end-time-${point.id}">To</label>
            <input class="event__input  event__input--time" id="event-end-time-${point.id}" type="text" name="event-end-time" value="${(0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_1__.formatDate)(isDateTo, _const_js__WEBPACK_IMPORTED_MODULE_2__.DateFormat.SHORT_DATE_TIME)}" required>
          </div>
...
/* harmony import */ var _view_button_new_event_view_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/button-new-event-view.js */ "./src/view/button-new-event-view.js");
...
const buttonNewEventComponent = new _view_button_new_event_view_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
...
(0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(buttonNewEventComponent, tripMainElement);
...
/******/ })()
;
//# sourceMappingURL=bundle.8992cef966f6400ca93a.js.map